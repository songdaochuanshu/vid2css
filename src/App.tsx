  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        {(step === 'frames' || step === 'analyzing') && (
          <>
            ...
            <div className="flex gap-3">
              <button
                onClick={handleReset}
                className="px-4 py-2 text-sm rounded-xl border border-white/10 text-[var(--text-secondary)] hover:bg-white/[0.03] transition-all"
              >
                Start Over
              </button>
              <button
      ...
      <footer className="py-4 text-center text-xs text-[var(--text-muted)] border-t border-white/5">
        <a href="https://github.com/songdaochuanshu/vid2css" target="_blank" className="hover:text-[var(--accent)] transition-colors">GitHub</a>
        {' \u00b7 '}
        MIT License
      </footer>
    </div>
